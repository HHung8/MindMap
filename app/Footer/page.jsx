      ...
      <div className="container mx-auto px-4">
        <div className="sm:flex sm:flex-wrap sm:-mx-4 md:py-4">
          <div className="px-4 sm:w-1/2 md:w-1/4 xl:w-1/6">
            <h5 className="text-xl font-bold mb-6">Feature</h5>
            <ul className="list-none footer-links">
              <li className="mb-2">
                <a
                  href="#"
                  className="border-b border-solid border-transparent hover:borer-purple-800 hover:text-purple-800"
                >
                  Cool stuff
                </a>
              </li>
          ...
          <div className="px-4 sm:w-1/3 xl:w-1/6 sm:mx-auto xl:mt-0 xl:ml-auto">
            ...
            <div className="flex sm:justify-center xl:justify-start">
              ...
              <span className="mx-4">
                <FontAwesomeIcon
                  icon={faGoogle}
                  className="w-8 h-8 border border-2 border-gray-400 rounded-full text-center py-1 text-gray-600 hover:text-white hover:bg-blue-600 hover:border-blue-400"
                />
              </span>
              <span>
                <FontAwesomeIcon
